...
create table activities_join (activity_id int8 not null, course_id int8 not null, user_id int8 not null, user_type varchar(255) not null, primary key (activity_id, course_id, user_id, user_type))
...
alter table activities_join add constraint FK1aahi3y8w9qntrusdw87subui foreign key (course_id) references courses
